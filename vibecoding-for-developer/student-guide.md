...
```bash
# 1. GitHub에서 선택한 구현체를 Fork (웹에서 Fork 버튼 클릭)
...
> **프롬프트:**
>
> 오늘 워크숍에서 진행한 클로드 코드 세션 로그를 분석해서
> 바이브 코딩 튜토리얼 문서를 작성해줘.
> 어떤 프롬프트를 사용했고, 어떤 결과를 얻었는지 정리해줘.

### Step 4-2: 전환 계획서 생성 (10분)

강사가 배포하는 generate-plan 스킬을 설치한다.
